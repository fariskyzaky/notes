                                ...
                                actions: [
                                  ...
                                  ElevatedButton(
                                      onPressed: () {
                                        ...
                                        FirebaseFirestore.instance
                                            .collection('notes')
                                            .doc(document.id) //--> sintax agar update berdasarkan id, kalo tidak ada ini maka akan mengupdate semua
                                            .update(updateNote)
                                            .whenComplete(
                                          () {
                                            Navigator.of(context).pop();
                          ...
                          onTap: () {
                            ...
                            actions: [
                                  Padding(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        Navigator.of(context).pop(); //--> Tombol Menutup dialog atau cancel
                                      },
                                      child: Text('Cancel'),
                                    ),
                                  ),
